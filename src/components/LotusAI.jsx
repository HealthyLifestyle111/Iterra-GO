...
const DOTERRA_BASE_URL = "https://www.doterra.com/US/en/site/jennawilliams1/p/";
              ...
              <div style={{padding:20,borderRadius:12,background:"linear-gradient(135deg, rgba(220,20,60,0.15), rgba(139,0,0,0.08))",border:"1px solid rgba(220,20,60,0.3)"}}>
                ...
                <div style={{display:"grid",gap:8,marginBottom:14}}>
                  <div style={{display:"flex",justifyContent:"space-between",alignItems:"center",padding:8,borderRadius:6,background:"rgba(245,222,179,0.04)"}}>
                    ...
                    <a href="https://www.doterra.com/US/en/site/jennawilliams1/p/holiday-joy-essential-oil-blend" target="_blank" rel="noopener noreferrer" style={{padding:"6px 12px",borderRadius:6,background:"linear-gradient(90deg,var(--bronze),var(--rosegold))",border:0,color:"#1b0b06",fontWeight:700,textDecoration:"none",fontSize:11,whiteSpace:"nowrap"}}>Shop</a>
                  </div>
                  <div style={{display:"flex",justifyContent:"space-between",alignItems:"center",padding:8,borderRadius:6,background:"rgba(245,222,179,0.04)"}}>
                    <span style={{fontSize:12,color:"var(--champagne)"}}>• Mulled cider blend</span>
                    <a href="https://www.doterra.com/US/en/site/jennawilliams1/p/wassail" target="_blank" rel="noopener noreferrer" style={{padding:"6px 12px",borderRadius:6,background:"linear-gradient(90deg,var(--bronze),var(--rosegold))",border:0,color:"#1b0b06",fontWeight:700,textDecoration:"none",fontSize:11,whiteSpace:"nowrap"}}>Shop</a>
                  </div>
                  <div style={{display:"flex",justifyContent:"space-between",alignItems:"center",padding:8,borderRadius:6,background:"rgba(245,222,179,0.04)"}}>
                    <span style={{fontSize:12,color:"var(--champagne)"}}>• Holiday diffuser</span>
                    <a href="https://www.doterra.com/US/en/site/jennawilliams1/p/lantern-diffuser-holiday" target="_blank" rel="noopener noreferrer" style={{padding:"6px 12px",borderRadius:6,background:"linear-gradient(90deg,var(--bronze),var(--rosegold))",border:0,color:"#1b0b06",fontWeight:700,textDecoration:"none",fontSize:11,whiteSpace:"nowrap"}}>Shop</a>
                  </div>
                </div>
              </div>
              ...
              <div style={{padding:20,borderRadius:12,background:"linear-gradient(135deg, rgba(220,20,60,0.15), rgba(139,0,0,0.08))",border:"1px solid rgba(220,20,60,0.3)"}}>
                ...
                <div style={{display:"grid",gap:8,marginBottom:14}}>
                  <div style={{display:"flex",justifyContent:"space-between",alignItems:"center",padding:8,borderRadius:6,background:"rgba(245,222,179,0.04)"}}>
                    ...
                    <a href="https://www.doterra.com/US/en/site/jennawilliams1/p/spa-hand-body-lotion-gift-set" target="_blank" rel="noopener noreferrer" style={{padding:"6px 12px",borderRadius:6,background:"linear-gradient(90deg,var(--bronze),var(--rosegold))",border:0,color:"#1b0b06",fontWeight:700,textDecoration:"none",fontSize:11,whiteSpace:"nowrap"}}>Shop</a>
                  </div>
                  <div style={{display:"flex",justifyContent:"space-between",alignItems:"center",padding:8,borderRadius:6,background:"rgba(245,222,179,0.04)"}}>
                    <span style={{fontSize:12,color:"var(--champagne)"}}>• Holiday bath bomb trio</span>
                    <a href="https://www.doterra.com/US/en/site/jennawilliams1/p/holiday-bath-bomb-trio" target="_blank" rel="noopener noreferrer" style={{padding:"6px 12px",borderRadius:6,background:"linear-gradient(90deg,var(--bronze),var(--rosegold))",border:0,color:"#1b0b06",fontWeight:700,textDecoration:"none",fontSize:11,whiteSpace:"nowrap"}}>Shop</a>
                  </div>
                  <div style={{display:"flex",justifyContent:"space-between",alignItems:"center",padding:8,borderRadius:6,background:"rgba(245,222,179,0.04)"}}>
                    <span style={{fontSize:12,color:"var(--champagne)"}}>• Calming seasonal blend</span>
                    <a href="https://www.doterra.com/US/en/site/jennawilliams1/p/holiday-peace-essential-oil-blend" target="_blank" rel="noopener noreferrer" style={{padding:"6px 12px",borderRadius:6,background:"linear-gradient(90deg,var(--bronze),var(--rosegold))",border:0,color:"#1b0b06",fontWeight:700,textDecoration:"none",fontSize:11,whiteSpace:"nowrap"}}>Shop</a>
                  </div>
                  <div style={{display:"flex",justifyContent:"space-between",alignItems:"center",padding:8,borderRadius:6,background:"rgba(245,222,179,0.04)"}}>
                    <span style={{fontSize:12,color:"var(--champagne)"}}>• Lavender essential oil</span>
                    <a href="https://www.doterra.com/US/en/site/jennawilliams1/p/lavender-essential-oil" target="_blank" rel="noopener noreferrer" style={{padding:"6px 12px",borderRadius:6,background:"linear-gradient(90deg,var(--bronze),var(--rosegold))",border:0,color:"#1b0b06",fontWeight:700,textDecoration:"none",fontSize:11,whiteSpace:"nowrap"}}>Shop</a>
                  </div>
                </div>
              </div>
              ...
              <div style={{padding:20,borderRadius:12,background:"linear-gradient(135deg, rgba(220,20,60,0.15), rgba(139,0,0,0.08))",border:"1px solid rgba(220,20,60,0.3)"}}>
                ...
                <div style={{display:"grid",gap:8,marginBottom:14}}>
                  <div style={{display:"flex",justifyContent:"space-between",alignItems:"center",padding:8,borderRadius:6,background:"rgba(245,222,179,0.04)"}}>
                    ...
                    <a href="https://www.doterra.com/US/en/site/jennawilliams1/p/himalayan-fir-essential-oil" target="_blank" rel="noopener noreferrer" style={{padding:"6px 12px",borderRadius:6,background:"linear-gradient(90deg,var(--bronze),var(--rosegold))",border:0,color:"#1b0b06",fontWeight:700,textDecoration:"none",fontSize:11,whiteSpace:"nowrap"}}>Shop</a>
                  </div>
                  <div style={{display:"flex",justifyContent:"space-between",alignItems:"center",padding:8,borderRadius:6,background:"rgba(245,222,179,0.04)"}}>
                    <span style={{fontSize:12,color:"var(--champagne)"}}>• Respiratory support blend</span>
                    <a href="https://www.doterra.com/US/en/site/jennawilliams1/p/breathe-respiratory-blend" target="_blank" rel="noopener noreferrer" style={{padding:"6px 12px",borderRadius:6,background:"linear-gradient(90deg,var(--bronze),var(--rosegold))",border:0,color:"#1b0b06",fontWeight:700,textDecoration:"none",fontSize:11,whiteSpace:"nowrap"}}>Shop</a>
                  </div>
                  <div style={{display:"flex",justifyContent:"space-between",alignItems:"center",padding:8,borderRadius:6,background:"rgba(245,222,179,0.04)"}}>
                    <span style={{fontSize:12,color:"var(--champagne)"}}>• Protective immune blend</span>
                    <a href="https://www.doterra.com/US/en/site/jennawilliams1/p/on-guard-protective-blend" target="_blank" rel="noopener noreferrer" style={{padding:"6px 12px",borderRadius:6,background:"linear-gradient(90deg,var(--bronze),var(--rosegold))",border:0,color:"#1b0b06",fontWeight:700,textDecoration:"none",fontSize:11,whiteSpace:"nowrap"}}>Shop</a>
                  </div>
                  <div style={{display:"flex",justifyContent:"space-between",alignItems:"center",padding:8,borderRadius:6,background:"rgba(245,222,179,0.04)"}}>
                    <span style={{fontSize:12,color:"var(--champagne)"}}>• Frankincense essential oil</span>
                    <a href="https://www.doterra.com/US/en/site/jennawilliams1/p/frankincense-essential-oil" target="_blank" rel="noopener noreferrer" style={{padding:"6px 12px",borderRadius:6,background:"linear-gradient(90deg,var(--bronze),var(--rosegold))",border:0,color:"#1b0b06",fontWeight:700,textDecoration:"none",fontSize:11,whiteSpace:"nowrap"}}>Shop</a>
                  </div>
                </div>
              </div>
              ...
              <div style={{padding:20,borderRadius:12,background:"linear-gradient(135deg, rgba(220,20,60,0.15), rgba(139,0,0,0.08))",border:"1px solid rgba(220,20,60,0.3)"}}>
                ...
                <div style={{display:"grid",gap:8,marginBottom:14}}>
                  ...
                  <div style={{display:"flex",justifyContent:"space-between",alignItems:"center",padding:8,borderRadius:6,background:"rgba(245,222,179,0.04)"}}>
                    ...
                    <a href="https://www.doterra.com/US/en/site/jennawilliams1/p/douglas-fir-essential-oil" target="_blank" rel="noopener noreferrer" style={{padding:"6px 12px",borderRadius:6,background:"linear-gradient(90deg,var(--bronze),var(--rosegold))",border:0,color:"#1b0b06",fontWeight:700,textDecoration:"none",fontSize:11,whiteSpace:"nowrap"}}>Shop</a>
                  </div>
                  <div style={{display:"flex",justifyContent:"space-between",alignItems:"center",padding:8,borderRadius:6,background:"rgba(245,222,179,0.04)"}}>
                    <span style={{fontSize:12,color:"var(--champagne)"}}>• Siberian fir essential oil</span>
                    <a href="https://www.doterra.com/US/en/site/jennawilliams1/p/siberian-fir-essential-oil" target="_blank" rel="noopener noreferrer" style={{padding:"6px 12px",borderRadius:6,background:"linear-gradient(90deg,var(--bronze),var(--rosegold))",border:0,color:"#1b0b06",fontWeight:700,textDecoration:"none",fontSize:11,whiteSpace:"nowrap"}}>Shop</a>
                  </div>
                  <div style={{display:"flex",justifyContent:"space-between",alignItems:"center",padding:8,borderRadius:6,background:"rgba(245,222,179,0.04)"}}>
                    <span style={{fontSize:12,color:"var(--champagne)"}}>• Cedarwood essential oil</span>
                    <a href="https://www.doterra.com/US/en/site/jennawilliams1/p/cedarwood-essential-oil" target="_blank" rel="noopener noreferrer" style={{padding:"6px 12px",borderRadius:6,background:"linear-gradient(90deg,var(--bronze),var(--rosegold))",border:0,color:"#1b0b06",fontWeight:700,textDecoration:"none",fontSize:11,whiteSpace:"nowrap"}}>Shop</a>
                  </div>
                </div>
              </div>
              ...
              <div style={{padding:20,borderRadius:12,background:"linear-gradient(135deg, rgba(220,20,60,0.15), rgba(139,0,0,0.08))",border:"1px solid rgba(220,20,60,0.3)"}}>
                ...
                <div style={{display:"grid",gap:8,marginBottom:14}}>
                  ...
                  <div style={{display:"flex",justifyContent:"space-between",alignItems:"center",padding:8,borderRadius:6,background:"rgba(245,222,179,0.04)"}}>
                    ...
                    <a href="https://www.doterra.com/US/en/site/jennawilliams1/p/rose-touch" target="_blank" rel="noopener noreferrer" style={{padding:"6px 12px",borderRadius:6,background:"linear-gradient(90deg,var(--bronze),var(--rosegold))",border:0,color:"#1b0b06",fontWeight:700,textDecoration:"none",fontSize:11,whiteSpace:"nowrap"}}>Shop</a>
                  </div>
                  <div style={{display:"flex",justifyContent:"space-between",alignItems:"center",padding:8,borderRadius:6,background:"rgba(245,222,179,0.04)"}}>
                    <span style={{fontSize:12,color:"var(--champagne)"}}>• Lavender essential oil</span>
                    <a href="https://www.doterra.com/US/en/site/jennawilliams1/p/lavender-essential-oil" target="_blank" rel="noopener noreferrer" style={{padding:"6px 12px",borderRadius:6,background:"linear-gradient(90deg,var(--bronze),var(--rosegold))",border:0,color:"#1b0b06",fontWeight:700,textDecoration:"none",fontSize:11,whiteSpace:"nowrap"}}>Shop</a>
              ...
              <div style={{marginBottom:16}}>
                ...
                <div style={{display:"grid",gap:8,marginBottom:14}}>
                  ...
                  <div style={{display:"flex",justifyContent:"space-between",alignItems:"center",padding:8,borderRadius:6,background:"rgba(245,222,179,0.04)"}}>
                    ...
                    <a href="https://www.doterra.com/US/en/site/jennawilliams1/p/wild-orange-oil" target="_blank" rel="noopener noreferrer" style={{padding:"4px 10px",borderRadius:6,background:"linear-gradient(90deg,var(--bronze),var(--rosegold))",border:0,color:"#1b0b06",fontWeight:700,textDecoration:"none",fontSize:10,whiteSpace:"nowrap"}}>Shop</a>
                  </div>
                  <div style={{display:"flex",justifyContent:"space-between",alignItems:"center",padding:8,borderRadius:6,background:"rgba(245,222,179,0.04)"}}>
                    <span style={{fontSize:13,color:"var(--champagne)"}}>• 2 drops Cinnamon Bark essential oil</span>
                    <a href="https://www.doterra.com/US/en/site/jennawilliams1/p/cinnamon-bark-oil" target="_blank" rel="noopener noreferrer" style={{padding:"4px 10px",borderRadius:6,background:"linear-gradient(90deg,var(--bronze),var(--rosegold))",border:0,color:"#1b0b06",fontWeight:700,textDecoration:"none",fontSize:10,whiteSpace:"nowrap"}}>Shop</a>
                  </div>
                  <div style={{display:"flex",justifyContent:"space-between",alignItems:"center",padding:8,borderRadius:6,background:"rgba(245,222,179,0.04)"}}>
                    <span style={{fontSize:13,color:"var(--champagne)"}}>• 1 drop Ginger essential oil</span>
                    <a href="https://www.doterra.com/US/en/site/jennawilliams1/p/ginger-oil" target="_blank" rel="noopener noreferrer" style={{padding:"4px 10px",borderRadius:6,background:"linear-gradient(90deg,var(--bronze),var(--rosegold))",border:0,color:"#1b0b06",fontWeight:700,textDecoration:"none",fontSize:10,whiteSpace:"nowrap"}}>Shop</a>
                  </div>
                </div>
                <p style={{fontSize:13,color:"var(--champagne)",lineHeight:1.7,marginBottom:10}}>
