...
<head>
    ...
    <title>iTerra Design Test</title>
    <style>
        ...
        *{box-sizing:border-box;margin:0;padding:0}
        ...
        .service-container{position:absolute;top:75%;left:50%;transform:translate(-50%,-50%);z-index:10}
...
<body>
    ...
    <div class="inner-sacred-geometry">
    ...
    <div class="header">
        <div class="logo">iTerra<span class="tm">™</span></div>
        <div class="tagline">Wellness Concierge</div>
    </div>

    <button class="wellness-intake-top" onclick="alert('Wellness Intake clicked')">
        Wellness Intake
    </button>

    <div class="service-container">
        <div class="service-grid">
            <button class="service-button" onclick="alert('Masculine Vitality')">Masculine Vitality</button>
            <button class="service-button" onclick="alert('Feminine Energy')">Feminine Energy</button>
            <button class="service-button" onclick="alert('Pet Harmony')">Pet Harmony</button>
            <button class="service-button" onclick="alert('Home Essentials')">Home Essentials</button>
            <button class="service-button" onclick="alert('Ageless Vitality')">Ageless Vitality</button>
            <button class="service-button" onclick="alert('Leadership & Wisdom')">Leadership & Wisdom</button>
        </div>
    </div>

    <div class="lotus-ai-container">
        <div class="lotus-ai" onclick="alert('Lotus AI')">
